...
/**
 * Classifies a Google Gmail API error into a structured category.
 * Google API error codes are the same across services.
 */
export function classifyGmailError(err: unknown): ClassifiedError {
  const e = err as any;
