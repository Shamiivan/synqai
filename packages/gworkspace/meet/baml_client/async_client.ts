...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.CreateMeeting | types.GetMeeting | types.EndMeeting | types.ListConferences | types.ListRecordings | types.ListTranscripts | types.GetTranscriptEntries | types.MeetRequestInfo | types.MeetDone> {
          try {
          ...
          const __stream__ = this.stream.MeetNextStep(
          thread,today,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.CreateMeeting | types.GetMeeting | types.EndMeeting | types.ListConferences | types.ListRecordings | types.ListTranscripts | types.GetTranscriptEntries | types.MeetRequestInfo | types.MeetDone
            } catch (error) {
            ...
            thread: string,today: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.CreateMeeting | partial_types.GetMeeting | partial_types.EndMeeting | partial_types.ListConferences | partial_types.ListRecordings | partial_types.ListTranscripts | partial_types.GetTranscriptEntries | partial_types.MeetRequestInfo | partial_types.MeetDone, types.CreateMeeting | types.GetMeeting | types.EndMeeting | types.ListConferences | types.ListRecordings | types.ListTranscripts | types.GetTranscriptEntries | types.MeetRequestInfo | types.MeetDone>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for MeetNextStep", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.CreateMeeting | partial_types.GetMeeting | partial_types.EndMeeting | partial_types.ListConferences | partial_types.ListRecordings | partial_types.ListTranscripts | partial_types.GetTranscriptEntries | partial_types.MeetRequestInfo | partial_types.MeetDone, types.CreateMeeting | types.GetMeeting | types.EndMeeting | types.ListConferences | types.ListRecordings | types.ListTranscripts | types.GetTranscriptEntries | types.MeetRequestInfo | types.MeetDone>(
                  __raw__,
                  (a): partial_types.CreateMeeting | partial_types.GetMeeting | partial_types.EndMeeting | partial_types.ListConferences | partial_types.ListRecordings | partial_types.ListTranscripts | partial_types.GetTranscriptEntries | partial_types.MeetRequestInfo | partial_types.MeetDone => a,
                  (a): types.CreateMeeting | types.GetMeeting | types.EndMeeting | types.ListConferences | types.ListRecordings | types.ListTranscripts | types.GetTranscriptEntries | types.MeetRequestInfo | types.MeetDone => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
